...
class BurgerBuilder extends Component {
    ...
    componentDidMount() {
        axios.get("https://react-my-burger-32eaa.firebaseio.com/ingredients.json")
        // axios.get("https://react-my-burger-32eaa.firebaseio.com/ingredients")
            .then(response => {
            ...
            .catch(error => {
                console.log("[BurgerBuilder][componentDidMount][error]=>");
                console.log(error);
                console.log("<=[BurgerBuilder][componentDidMount][error]");   
    ...
    render() {
        ...
        let burger = (this.state.error) ? <p>Error: Ingredients cannot be loaded.</p> : <Spinner />;
